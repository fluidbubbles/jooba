...
> **Note:** For local development without API keys, set `EMAIL_PROVIDER=mock` and `LLM_PROVIDER=mock` in your `.env`. Emails will be logged instead of sent and classification will return dummy results.
