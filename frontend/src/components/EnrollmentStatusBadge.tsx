...
interface EnrollmentStyleEntry {
  dot: string
  bg: string
  text: string
  label: string
...
const ENROLLMENT_STYLES: Record<EnrollmentStatus, EnrollmentStyleEntry> = {
...
export default function EnrollmentStatusBadge({ status }: Props) {
