...
export default function Settings() {
      ...
      <div className="rounded-lg border border-green-200 bg-green-50 p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-900">{connection?.email || 'Connected account'}</p>
            {connectedAt && (
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 border border-red-300 text-red-600 hover:bg-red-50 text-sm rounded-lg transition-colors disabled:opacity-40"
          >
            <Unplug size={14} />
    ...
    emailConnectionBody = (
      <div className="text-center py-6">
        <div className="flex items-center gap-2 mb-3 justify-center">
          ...
          <span className="text-amber-600 text-sm font-medium">Status Unavailable</span>
        </div>
        ...
        <div className="flex items-center justify-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 border border-amber-400 text-amber-700 hover:bg-amber-50 text-sm rounded-lg transition-colors"
          >
            <RotateCcw size={14} />
            Retry
          </button>
  ...
  return (
    <div className="p-8 max-w-2xl">
      <h1 className="text-[28px] font-semibold tracking-tight text-gray-900 mb-8">Settings</h1>
      ...
      <div className="mb-8">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-gray-900 font-medium">Email Account</h3>
